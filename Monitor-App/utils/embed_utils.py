...
def add_embed_elements(embed):
    ...
    embed.add_field(
        name="Need Help?",
        value="For additional help, visit [the documentation](https://thedartproject.github.io/pages/monitor-app.html) or contact the project's owner <@212020258402205697>.",
        inline=False,
    )
